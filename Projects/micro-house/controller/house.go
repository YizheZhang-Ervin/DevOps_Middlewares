...
import (
	...
	"fmt"
	"image/png"
	getArea "micro-house/proto/getArea/proto/getArea"
	getImg "micro-house/proto/getImg/proto/getImg"
	houseMicro "micro-house/proto/house/proto/house"
	orderMicro "micro-house/proto/order/proto/userOrder"
	register "micro-house/proto/register/proto/register"
	user "micro-house/proto/user/proto/user"
	"micro-house/utils"
	"net/http"
	"path"
